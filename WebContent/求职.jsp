...
<div id="header">
    <div class="inner home-inner">
        ...
        <div class="nav">
            <ul>
                <li class=""><a ka="header-home"  href="index5_22.html" >首页</a></li>
        ...
        <div class="user-nav">
                ...
                <!--未登录-->
                <div class="btns">
                <a href="/user/signup.html?intent=1" class="link-publish" ka="header-publish" title="免费发布职位">免费发布职位</a><em class="vline"></em><a href="https://sao.zhipin.com" ka="header-sao" class="link-scan">扫码登录</a><a href="#" ka="header-register"  class="btn btn-outline" >注册</a><a href="#" ka="header-login"  class="btn btn-outline" >登录</a></div>
  ...
  $(document).ready(function(){
	...
	if (useremail!=null && useremail!="")
	  { 
		//有cookies
		$(".user-nav").empty();
		 var txt1="<ul><li class=\" \"><a ka=\"header-message\" href=\"https://www.zhipin.com/gchat/chat.html \" >消息<span class=\"nav-chat-num\"></span></a></li><li class=\"\"><a ka=\"header-resume\" href=\"https://www.zhipin.com/geek/myresume.html\" >简历</a></li><li class=\"nav-figure\"><a href=\"https://www.zhipin.com/geek/new/index/recommend\" ka=\"header-username\" ><span class=\"label-text\">鲁春阳</span> <img src=\"https://img2.bosszhipin.com/boss/avatar/avatar_15.png\" alt=\"\" /></a><div class=\"dropdown\"><a href=\"https://www.zhipin.com/geek/new/index/recommend\" ka=\"header-personal\">个人中心</a><a href=\"https://www.zhipin.com/geek/account/management\" ka=\"account_manage\">账户管理</a><a href=\"https://www.zhipin.com/geek/privacy/settingpage\" ka=\"privacy_manage\">隐私设置</a><a href=\"https://www.zhipin.com/geek/item/mall.html\" class=\"link-mall\" ka=\"recruit_assistant\">求职助手</a><a href=\"javascript:;\" class=\"link-recruit\" ka=\"header-recruit\">我要招聘</a><a href=\"https://www.zhipin.com/logout/\" ka=\"header-logout\">退出</a><p class=\"recruit-tip\"><img src=\"/v2/web/geek/images/recruit-tip.gif\" alt=\"\"><span>在 APP 端“我的 - 设置”中切换为Boss身份后，刷新本页面即可进行招聘</span></p></div></li></ul>";     
		 $(".user-nav").append(txt1);
		 ...
		 $(".nav-figure").mouseenter(function(){
				$(".dropdown").css("display","block");
				  });
		 $(".nav-figure").mouseleave(function(){
